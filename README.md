...
Честная граница проведена прямо в интерфейсе: **камерой сейчас меряется развал**
(и точнее угломера — перекос крепления мишени не важен), а **схождение и угол
тяги — нет**. Для этого нужно связать все четыре колеса в одну систему координат
(общая напольная реперная мишень в каждом кадре) — это ещё не сделано. Схождение
по-прежнему выставляется по струне.
...
1. Регистрация четырёх колёс в одной системе координат по напольной реперной
   мишени — включит оптическое измерение схождения и угла тяги.
